...
public sealed class CreeperFearDeathDropAndSanityTests
{
    ...
    [Fact]
    public void Lethal_creeper_hit_stages_one_hp_then_captures_true_zero_dying_profile()
    {
    ...
    [InlineData(5000, 1)]
    [InlineData(9999, 1)]
    public void Shipped_creeper_drop_uses_strict_half_boundary_once(
        int roll,
    ...
    [Fact]
    public void Creeper_terminal_window_keeps_all_256_receipts_without_eviction()
    {
        var profile = RuntimeProfile();
        var fixture = Fixture();
