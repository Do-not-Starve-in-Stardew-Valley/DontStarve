...
/// <summary>
/// Draws the loader-owned Mr.Skitts sheet only for the current owner screen. Placeholder or
/// provisional metadata gets a magenta outline, so local proof cannot be mistaken for final art.
/// </summary>
internal sealed class MrSkittsProjectionRenderer : IHarmlessProjectionWorldRenderer
{
    public void Draw(
    ...
    )
    {
        ...
        {
            throw new InvalidOperationException("mr-skitts.visual-resource-unavailable");
        }
        ...
        {
            throw new InvalidOperationException("mr-skitts.visual-source-out-of-range");
        }
