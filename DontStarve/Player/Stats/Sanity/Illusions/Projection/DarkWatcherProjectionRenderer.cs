...
/// <summary>
/// Draws only the loader-owned Watcher runtime sheet on the exact owner screen. The shipped
/// profile remains visibly marked while its pivot, scale, and timing are provisional.
/// </summary>
internal sealed class DarkWatcherProjectionRenderer
    : IHarmlessProjectionWorldRenderer
{
    public void Draw(
    ...
    )
    {
        ...
        )
        {
            throw new InvalidOperationException(
                "dark-watcher.visual-resource-unavailable"
            );
        }
        ...
        {
            throw new InvalidOperationException(
                "dark-watcher.visual-source-out-of-range"
            );
        }
